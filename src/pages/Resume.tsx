    ...
    <div className="min-h-screen pt-24 pb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
            <div>
              ...
              <p className="text-muted-foreground max-w-2xl">
                A detailed overview of my professional experience, education, and technical skills in mobile app development.
              </p>
            </div>
        ...
        <AnimatedSection delay={400}>
          <div>
            <h2 className="text-2xl font-bold mb-6 pb-2 border-b">Certifications</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {certifications.map((cert, index) => (
                <div key={index} className="bg-card border border-border rounded-lg p-5 flex justify-between hover:border-primary/50 transition-colors">
                  <div>
                    <h3 className="font-bold">{cert.name}</h3>
                    <p className="text-muted-foreground text-sm">{cert.issuer} · {cert.date}</p>
                  </div>
                  <a href={cert.link} className="text-primary text-sm hover:underline">View</a>
                </div>
              ))}
            </div>
          </div>
