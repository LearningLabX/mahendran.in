  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="flex h-full min-h-screen w-full">
        ...
        <SidebarInset className="px-4 md:px-8 py-6 overflow-auto flex-1 bg-white dark:bg-slate-950">
          <div className="flex items-center pb-6 border-b border-slate-200 dark:border-slate-800">
